...
public:
    ...
    {
        try {
            // Format the connection string for pqxx
            std::string conn_str = fmt::format("dbname={} user={} password={} host={} port={}",
    ...
    try {
        ...
        if (operation == "create") {
            if (!vm.count("name") || !vm.count("email") || !vm.count("age")) {
                std::cerr << "Create operation requires --name, --email, and --age.\n";
                return 1;
            }
...
// src/demo/rdbms/demo_pqsql_without_ssl --operation create --name "John Doe" --email "john.doe@example.com" --age 30
// src/demo/rdbms/demo_pqsql_without_ssl --operation read --user app_user --password app_pwd
// src/demo/rdbms/demo_pqsql_without_ssl --operation update --id 1 --email "john.smith@example.com" --age 31
// src/demo/rdbms/demo_pqsql_without_ssl --operation delete --id 1 --user app_user --password app_pwd
